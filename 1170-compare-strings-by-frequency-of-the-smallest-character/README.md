...
<pre style="position: relative;"><strong>Input:</strong> queries = ["cbd"], words = ["zaaaz"]
...
<pre style="position: relative;"><strong>Input:</strong> queries = ["bbb","cc"], words = ["a","aa","aaa","aaaa"]
