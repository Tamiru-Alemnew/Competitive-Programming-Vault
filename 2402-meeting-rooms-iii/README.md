...
<pre style="position: relative;"><strong>Input:</strong> n = 2, meetings = [[0,10],[1,5],[2,7],[3,4]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 3, meetings = [[1,20],[2,10],[3,5],[4,9],[6,8]]
