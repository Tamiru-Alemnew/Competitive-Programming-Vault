...
<pre style="position: relative;"><strong>Input:</strong> arr = [9,4,2,10,7,8,8,1,9]
...
<pre style="position: relative;"><strong>Input:</strong> arr = [4,8,12,16]
<strong>Output:</strong> 2
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> arr = [100]
